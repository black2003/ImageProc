...
if upload is not None:
    ...
    st.sidebar.header("Hyper Parameter Tuning for Canny Filter")
    ...
    img = cv2.drawContours(imgnext,New_img,-1,color=(255,0,0),thickness=thk)
